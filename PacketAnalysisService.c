...
void InitDB()
{
	...
	// example : !mysql_real_connect(&conn, "1.234.83.38", "admin", "test1234", "TESTDB", 3306, NULL, 0) 
	if(!mysql_real_connect(&conn, "ip address", "db user", "db password", "database name", 3306, NULL, 0)){
